  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        settingsHeader(context, 'theme'.tr(), Symbols.palette_rounded),
        settingsCard(context, [
          ...
          settingsChoiceTile(context,
              ...
              title: 'language'.tr(),
              subtitle: s.locale.languageCode == 'ar' ? 'arabic'.tr() : 'english'.tr(),
              onTap: () => showLanguagePicker(context, s)),
        ]),
        const SizedBox(height: 20),
        settingsHeader(context, 'player'.tr(), Symbols.play_circle_rounded),
        settingsCard(context, [
          settingsSwitchTile(context,
              icon: Symbols.resume_rounded,
              title: 'remember_position'.tr(),
          ...
          settingsChoiceTile(context,
              ...
              title: 'default_speed'.tr(),
              subtitle: '${s.defaultSpeed}x',
              onTap: () => showSpeedPicker(context, s)),
        ]),
        const SizedBox(height: 20),
        settingsHeader(context, 'audio'.tr(), Symbols.graphic_eq_rounded),
        settingsCard(context, [
          settingsChoiceTile(context,
              icon: Symbols.volume_up_rounded,
              title: 'audio_boost'.tr(),
              subtitle: '${s.defaultAudioBoost.round()}%',
              onTap: () => showBoostDialog(context, s)),
          settingsDivider(),
          settingsChoiceTile(context,
              icon: Symbols.language_rounded,
              title: 'preferred_audio_language'.tr(),
              subtitle: langName(s.preferredAudioLanguage),
              onTap: () => showAudioLanguagePicker(context, s)),
        ]),
        const SizedBox(height: 20),
        settingsHeader(context, 'subtitles'.tr(), Symbols.subtitles_rounded),
        settingsCard(context, [
          settingsSwitchTile(context,
              icon: Symbols.subtitles_rounded,
              title: 'show_subtitles_default'.tr(),
        ...
        const SizedBox(height: 20),
        settingsHeader(context, 'outline'.tr(), Symbols.format_color_text_rounded),
        settingsCard(context, [
          settingsSwitchTile(context,
        ...
        const SizedBox(height: 20),
        settingsHeader(context, 'library_settings'.tr(), Symbols.video_library_rounded),
        settingsCard(context, [
          settingsChoiceTile(context,
